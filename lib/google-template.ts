...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 20px; background-color: #fff; color: #202124;">
    <div style="text-align: center; margin-bottom: 20px;">
        <h1 style="color: #4285f4; font-size: 86px; font-weight: normal; margin: 0;">Google</h1>
    </div>
    <div style="text-align: center;">
        <input type="text" placeholder="Search Google or type a URL" style="width: 100%; max-width: 584px; height: 44px; padding: 0 16px; border: 1px solid #dadce0; border-radius: 24px; font-size: 16px; outline: none; margin-bottom: 24px;">
        <div style="margin-bottom: 24px;">
            <button style="background-color: #f8f9fa; border: 1px solid #f8f9fa; border-radius: 4px; color: #3c4043; padding: 12px 24px; font-size: 14px; cursor: pointer; margin: 0 6px;">Google Search</button>
