  ...
  private generateWebsiteContent(domain: string): string {
    ...
    const templates = {
      'google.com': `
        ...
        <p>Welcome to Google! The search engine that powers the internet.</p>
        </body>
        </html>
      `,
      'github.com': `
        ...
        <div>Millions of developers and companies build, ship, and maintain their software on GitHub</div>
        </body>
        </html>
      `,
      'stackoverflow.com': `
